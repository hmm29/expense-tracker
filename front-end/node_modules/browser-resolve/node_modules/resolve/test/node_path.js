...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.equal(res, __dirname + '/node_path/x/aaa/controller.js');
    });
    ...
    resolve('bbb', {
        ...
        t.equal(res, __dirname + '/node_path/y/bbb/controller.js');
    });
    ...
    resolve('ccc', {
        ...
        t.equal(res, __dirname + '/node_path/x/ccc/controller.js');
    });
